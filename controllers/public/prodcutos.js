...
const CATEGORIA_API = 'business/dashboard/prodcutos.php';
// Constante para establecer el contenedor de categorías.
const CATEGORIAS = document.getElementById('product');
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    if (JSON.status) {
        ...
        JSON.dataset.forEach(row => {
            ...
            <div class="card-img">
                <img src="../../resources/img/ps4-removebg-preview.png" alt="" class="w-100 h-100">
            </div>
            <div class="card-info">
